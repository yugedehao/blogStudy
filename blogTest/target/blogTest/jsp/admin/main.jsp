...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light" >
        ...
        <a class="navbar-brand text-success" href="/jsp/admin/main">博客管理</a>
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="/jsp/admin/main">主页 </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/jsp/admin/article/list">文章管理</a>
                </li>
            </ul>
            <form class="form-inline my-2 my-lg-0" action="/jsp/admin/article/search" method="GET">
            ...
            <a class="btn btn-outline-danger btn-sm" href="/jsp/admin/logout" role="button">退出</a>
        </div>
    </nav>
    <div class="card mb-3">
